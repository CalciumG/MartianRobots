...
To run the program you must have .NET Core v-3.1.0 or later installed, then you can cd into the folder location and then use the command dotnet run - eg:

```
cd C:\Users\Callum.gordon\source\repos\MartianRobots\MartianRobots
dotnet run
```
